...
export const ITJOB_INTRODUCTION = [
  {
    ...
    content: (
      <>
        初の実務だった為、まずは基本作法を学びながらページの改修作業を行いました。
        <br />
        転職活動中にコーディングの勉強をしていた為、ある程度の改修部分も理解する事が出来、先輩方からも優しく教授して頂き本当感謝しています。{' '}
      </>
    ),
  ...
  },
  {
    ...
    content: (
      <>
        カスタマーでは不具合調査によるナレッジ作成や、調査方法を学ぶことが出来ました。
        <br />
        講師では主に初学者へのGitやクラウド関連の作法の作法講師だったので、質問されるであろう事象を理解する為何度も勉強したり、人に教える難しさを学びました。
        <br />
        ですが、実務へのスキルアップには繋がらないと感じ、更新時に次の現場希望を出しました。
      </>
    ),
    hukidashi: (
      <>
        正直「SESは開発以外も経験する」と言う噂は本当だったんだなと実感した現場でした（笑）
      </>
    ),
  },
  {
