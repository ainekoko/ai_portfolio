...
export const ITJOB_INTRODUCTION = [
  ...
  {
    outsourcedCompany: 'クラウドサービス会社（自社開発）',
    period: '常駐先/出社/6か月',
    scale: 'PM2名、その他15名',
    ...
    achievements: [
      '新人研修プログラムを構築し、5名以上の育成に貢献',
      'ナレッジベース構築により問い合わせ対応時間を30%削減',
    ],
    content: (
      <>
        カスタマーサポートでは不具合調査とナレッジベース構築を担当。
        技術講師として新人エンジニアへのGit・クラウド研修を実施し、質問を想定した徹底的な準備により、教える技術とコミュニケーション能力を向上させました。
  ...
  {
    outsourcedCompany: '保険会社（自社開発）',
    period: '常駐先/出社/1年半',
    scale: '営業1名、PM4名、デザイナー3名、FE8名、BE8名',
    phase: ['UI/UXデザイン', '詳細設計', '開発', 'テスト'],
    bussinessContent: [
      'デザイン案の作成とプレゼンテーション',
      '保険シミュレーションページ作成（Vue.js）',
      'レガシーコードのVue.js移行（15ページ以上）',
      '単体テスト・結合テスト（カバレッジ100%達成）',
    ],
    devenvironment: {
  ...
  },
  {
    ...
    hukidashi: <>前職の化粧品業界の知識が活かせて、とても嬉しかったです！</>,
  },
  {
    ...
    content: (
      <>
        ...
        特にオリンピック特設ページでは、D3.jsを使用したリアルタイムのメダル獲得状況可視化機能が高評価を獲得。
        この現場で動きのあるサイトの面白さを実感し、フロントエンド技術をより深く追求したいと考えるきっかけとなりました。
      </>
    ),
    hukidashi: (
      <>オリンピック期間中は徹夜続きでしたが、やりがいのある2年間でした！</>
    ),
  },
  {
    ...
    bussinessContent: [
      ...
      'チームリーダーとしてタスク管理・新人教育',
      '単体テスト・結合テスト（Jest・Testing Library）',
    ],
    devenvironment: {
    ...
    content: (
      <>
        ...
        要件定義からテストまで一貫して携わり、メンバーへのタスク振り分けや新人教育も実施しました。
        初の大規模開発とフルリモート案件のため、報連相を徹底し、1日の作業を日報形式で記録。
        不明点があれば即座にオンライン会議を設定するなど、コミュニケーションの質を重視しました。
        この経験を通じて、技術力だけでなくチームマネジメントのスキルも大きく向上しました。
      </>
    ),
    hukidashi: (
      <>フルリモートでのチーム管理は大変でしたが、成長できた1年でした！</>
    ),
  },
];
