        ...
        <div className='embla__viewport bg-[#ffffff]' ref={emblaRef}>
          <div className='embla__container lg:flex lg:flex-row flex-col'>
            {ITJOB_INTRODUCTION.map((content, index) => (
              <div
                key={index}
                className='border border-gray-300 p-8 md:p-12 mb-12 relative'
              >
                {/* <!-- 番号 --> */}
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 gap-12'>
                  ...
                  <div className='space-y-6'>
                    <div className='flex mb-2'>
                      <div className='w-24 font-light text-gray-600'>業種</div>
                      <div className='flex-1'>{content.outsourcedCompany}</div>
                    </div>

                    <div className='flex mb-2'>
                      <div className='w-24 font-light text-gray-600'>規模</div>
